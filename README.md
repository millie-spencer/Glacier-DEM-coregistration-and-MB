...
Note: The ASTER DEM is a bias-corrected 30 m product from Hugonnet et al. (2021), available on request. The Pléiades DEM was obtained from the Dirección General de Aguas (DGA) under the Chilean Transparency Act.
